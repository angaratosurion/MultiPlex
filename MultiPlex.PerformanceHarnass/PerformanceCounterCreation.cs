    ...
    public static class PerformanceCounterCreation
    {
        public static void Create()
        {
            ...
            PerformanceCounterCategory category = PerformanceCounterCategory.Create(
                "MultiPlex.PerformanceCounters",
                "MultiPlex perf counters.",
        ...
        public static void Remove()
        {
            if (Exists())
            {
                Console.WriteLine("Deleting existing MultiPlex.PerformanceCounters perf counters.");

                PerformanceCounterCategory.Delete("MultiPlex.PerformanceCounters");
            }
        }

        public static bool Exists()
        {
            return PerformanceCounterCategory.Exists("MultiPlex.PerformanceCounters");
        }
    }
}