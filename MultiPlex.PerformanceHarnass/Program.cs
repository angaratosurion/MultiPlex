...
using MultiPlex.Syndication;

namespace MultiPlex.PerformanceHarnass
{
    internal class Program
    {
        ...
        static Program()
        {
            ...
            AvgTimeTicks = new PerformanceCounter("MultiPlex.PerformanceCounters", "Avg Rendering Time (seconds)", string.Empty, false);
            AvgTimeTicksBase = new PerformanceCounter("MultiPlex.PerformanceCounters", "Avg Rendering Time Base", string.Empty, false);
            NumThreads = new PerformanceCounter("MultiPlex.PerformanceCounters", "Num Rendering Threads", string.Empty, false);
            AvgPerSec = new PerformanceCounter("MultiPlex.PerformanceCounters", "Avg Rendering Per Sec", string.Empty, false);
        }
        ...
        {
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("MultiPlex.PerformanceHarnass.Data." + dataName + ".wiki"))
